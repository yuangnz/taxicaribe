                ...
                <Container size="lg" p="md" style={{
                    ...
                    <Group justify='space-between'>
                        ...
                        <Group gap={30} visibleFrom="xs" mx="xl">
                            <UnstyledButton className={classes.buttonh}>Home</UnstyledButton>
                            <UnstyledButton className={classes.buttonh}>Services</UnstyledButton>
                            <UnstyledButton className={classes.buttonh}>Steps</UnstyledButton>
                            <UnstyledButton className={classes.buttonh}>Plans</UnstyledButton>
                            <UnstyledButton className={classes.buttonh}>Contact</UnstyledButton>
                            <Menu trigger="click-hover" openDelay={100} closeDelay={400} transitionProps={{ transition: 'rotate-right', duration: 150 }}>
                                <Menu.Target>
                                    <Button variant="light" color="orange" autoContrast size="xs" radius="lg"> <Flag code="us" height="13" /> <Text>-</Text> English</Button>
                                </Menu.Target>
                                ...
                                <Menu.Dropdown>
                                    ...
                                    <Menu.Item onClick={() => handleClick('/es')} >
                                        <Flag code="es" height="13" /> Español
                                    </Menu.Item>
                                    <Menu.Item
